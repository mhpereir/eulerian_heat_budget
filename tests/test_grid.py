...
def test_determine_domain_preserves_staged_pressure_bounds():
    ds = _make_dataset(
        ...
        {
            "p_start": ("level", np.array([95000.0, 85000.0])),
            "p_end": ("level", np.array([85000.0, 75000.0])),
        }
    )
    ...
    np.testing.assert_allclose(dom["p_start"].values, np.array([95000.0, 85000.0]))
    np.testing.assert_allclose(dom["p_end"].values, np.array([85000.0, 75000.0]))
    np.testing.assert_allclose(halo["p_start"].values, np.array([95000.0, 85000.0]))
    np.testing.assert_allclose(halo["p_end"].values, np.array([85000.0, 75000.0]))
